...
class Server{
    private:
        ...
        int epfd;
    public:
        Server(int port_ = 8080):port(port_),lsock(-1), epfd(-1)
        {
        }
        void InitServer()
        {
        ...
        void HanderEvents(int epfd, struct epoll_event *revs, int num)
        {
            ...
            for(int i = 0; i < num; i++){
                ...
                if(revs[i].events & EPOLLIN){
                    ...
                    string http_echo = "HTTP/1.1 200 OK\r\n\r\n<html><body><h1>hello EPOLL Server</h1><img src=\"https://c-ssl.duitang.com/uploads/item/201210/26/20121026223826_CzrmW.thumb.700_0.jpeg\" alt=\"test\"/></body></html>";
